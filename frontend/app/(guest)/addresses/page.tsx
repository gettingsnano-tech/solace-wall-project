...
export default function AddressesLandingPage() {
  const sections = [
    {
      title: "Synthetically Generated Addresses",
      desc: "Our platform simulates the cryptographic generation of public wallet addresses. Every address in our pool follows the checksum and character standards of its respective blockchain network.",
      icon: <Hash className="w-8 h-8" />
    },
    {
      title: "Network-Specific Mapping",
      desc: "Experience how addresses are mapped to specific protocols. From the '0x' prefix of EVM-compatible networks to the 'T' prefix of Tron, our simulator handles the technical nuances of blockchain addressing.",
      icon: <Cpu className="w-8 h-8" />
    },
    {
      title: "Pooled Liquidity Sources",
      desc: "Simulate incoming asset flows from high-repute pooled addresses. Our system manages a vast pool of synthetic sender addresses to provide a realistic transaction environment for your presentation.",
      icon: <Layout className="w-8 h-8" />
    },
    {
      title: "Privacy and Obfuscation",
      desc: "Learn about the pseudo-anonymous nature of blockchain addresses. Even in a simulation, we demonstrate how public keys protect identity while ensuring the transparency of the transaction ledger.",
    ...
    <div className="pt-32 pb-20">
      ...
      <section className="container mx-auto px-6 mb-24">
         ...
         >
            ...
            <h1 className="text-5xl md:text-7xl font-black mb-8">Cryptographic <br /><span className="text-gradient">Address Simulation</span></h1>
            <p className="text-gray-400 text-lg md:text-xl leading-relaxed">
               Understand the identity layer of the blockchain. High-fidelity synthetic address generation for the next generation of digital asset demos.
            </p>
         </motion.div>
      </section>
      ...
      <section className="container mx-auto px-6 mt-32">
         <div className="glass-card p-16 rounded-[4rem] flex flex-col lg:flex-row items-center gap-16 bg-white/[0.01]">
            <div className="lg:w-1/2">
               ...
               <p className="text-gray-400 leading-relaxed mb-10">Our back-end uses cryptographically secure random number generators (CSPRNG) to synthesize addresses that are indistinguishable from real blockchain keys within a demo context.</p>
               <div className="space-y-4">
                  <div className="flex items-center space-x-4 text-xs font-bold text-gray-500">
                     ...
                     <span>Compliant with BIP-39 Standards Simulation</span>
                  </div>
                  <div className="flex items-center space-x-4 text-xs font-bold text-gray-500">
                     <div className="w-1.5 h-1.5 rounded-full bg-[var(--secondary)]"></div>
            ...
            <div className="lg:w-1/2 w-full">
               <div className="bg-[#0A0E1A] p-8 rounded-[2rem] border border-white/5 font-mono text-xs space-y-3 shadow-inner">
                  <div className="text-[var(--secondary)]">// Initializing simulated address pool</div>
                  <div className="text-white">const chain = "ERC-20";</div>
                  <div className="text-white">const address = generateSimulatedAddress(chain);</div>
